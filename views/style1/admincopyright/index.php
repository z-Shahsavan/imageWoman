...
<div class="row" >
    <ul class="adminmnu col-xs-12">
        ...
        <li><a href="[VARURL]admincopyright" class="active">حقوق استفاده کنندگان</a></li>
...
</div><div id="modaledit" class="modal">
    <div class="modal-content">
        <form action="#" id="formedit" method="post" autocomplete="off" class="col s12 m5 offset-m3 container">
            ...
            <div class="row">
                <div id="msgerrmod" class="col s12 pink-text text-darken-3 right-align" style="display: none">این </div>
...
<div id="cntmndiv" class="row grey lighten-3 mgbtmz">
    <div class="clearfix">
        <ul id="sidemenu" class="rtl">
            ...
            <li><a id="editcopyhead" href="#edit-content" class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="ویرایش موضوعات"><i class="mdi-editor-mode-edit Medium"></i></a></li>
        </ul>
        <div id="content">
                ...
                <div class="row mgbtmz container">
                    <form action="#" id="formreg" method="post" autocomplete="off" class="col s12 m5 offset-m3 mgtop z-depth-1 reltive minsh mgbtm bgblur bdr">
                        <div class="col s12 rtl">
                            <h4 class="flow-text blue-grey darken-3 hdreg white-text">حقوق استفاده کنندگان</h4>
                        </div>
                        <div class="row mgtop">
                            <div class="input-field col s12 right">
                                <i class="mdi-action-toc prefix"></i>
