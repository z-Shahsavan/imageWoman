...
$(function() {
    ...
    $('#itemsdiv').on('click', '.editcmp', function() {
        ...
        $("#edit").on('click', function() {
            ...
            $.ajax({
                url: siteurl + "admincopyright/editcop",
                type: "POST",
                data: a,
                dataType: 'json',
    ...
    $('#itemsdiv').on('click', '.delcmt', function() {
        ...
        if (agree) {
            ...
            ;
            $.ajax({
                url: siteurl + "admincopyright/dltcmnt",
                type: "POST",
                data: {
                    "dlt": id
                }
...
$(function() {
    ...
    $('#send').on('click', function() {
        ...
        $.ajax({url: siteurl + 'admincopyright/savecopyright',
            data: data,
            type: 'POST',
            dataType: 'json',
            success: function(result) {
    ...
    $('#editcopyhead').click(function() {
        $.ajax({
            url: siteurl + 'admincopyright/loadcopyrules',
            type: 'POST',
            dataType: 'json',
            success: function(result) {
