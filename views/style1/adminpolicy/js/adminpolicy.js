...
$(function() {
    ...
    $('#itemsdiv').on('click', '.editcmp', function() {
        ...
        $("#edit").on('click', function() {
            ...
            $.ajax({
                url: siteurl + "adminpolicy/edepolicy",
                type: "POST",
                data: a,
                dataType: 'json',
    ...
    $('#itemsdiv').on('click', '.delcmt', function() {
        ...
        if (agree) {
            ...
            $.ajax({
                url: siteurl + "adminpolicy/dltcmnt",
                type: "POST",
                data: {
                    "dlt": id
                }
...
$(function() {
    ...
    $('#send').on('click', function() {
        ...
        $.ajax({url: siteurl + 'adminpolicy/regrules',
            data: data,
            type: 'POST',
            dataType: 'json',
            success: function(result) {
    ...
    $('#editpolicyhead').click(function() {
        $.ajax({
            url: siteurl + 'adminpolicy/loadrules',
            type: 'POST',
            dataType: 'json',
            success: function(result) {
