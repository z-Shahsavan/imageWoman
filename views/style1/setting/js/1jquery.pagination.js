    ...
    $.extend($.PaginationRenderers.defaultRenderer.prototype, {
        ...
        createLink: function (page_id, current_page, appendopts) {
            ...
            if (page_id == current_page) {
                lnk = $('<li class="active"><span class="current">' + appendopts.text + "</span></li>");
            }
            else {
                lnk = $('<li class="waves-effect">' + appendopts.text + "</li>")
            }
        ...
        getLinks: function (current_page, eventHandler) {
            var begin, end,
				...
				np = this.pc.numPages(),
				fragment = $('<ul id="pgsdiv" class="ltr pagination"></ul>');
            ...
            if (interval.start > 0 && this.opts.num_edge_entries > 0) {
                ...
                if (this.opts.num_edge_entries < interval.start && this.opts.ellipse_text) {
                    $('<li class="disabled"><span>' + this.opts.ellipse_text + "</span></li>").appendTo(fragment);
                }
            }
            ...
            $('li', fragment).click(eventHandler);
            return fragment;
        }
    });
