...
class mobservios_model extends Model {
    ...
    public function iduser($cond, $condata) {
        return $this->db->select('tbl_users', '*', $cond, $condata);
    }

    public function login($cond, $data) {
    ...
    public function editavatar($updata, $cond, $condata) {
        return $this->db->update('tbl_users', $updata, $cond, $condata);
    }
